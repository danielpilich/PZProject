...
namespace AfterlifeApp.Controllers
{
    public class GamesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Game.Include(g => g.Bundle).Include(g => g.Category);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Rating,Price,CategoryId,BundleId")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Rating,Price,CategoryId,BundleId")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
